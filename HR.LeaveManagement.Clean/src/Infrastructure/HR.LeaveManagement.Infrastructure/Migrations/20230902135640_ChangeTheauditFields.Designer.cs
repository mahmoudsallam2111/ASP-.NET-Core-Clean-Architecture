...
namespace HR.LeaveManagement.Infrastructure.Migrations
{
    ...
    [Migration("20230902135640_ChangeTheauditFields")]
    partial class ChangeTheauditFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 9, 2, 16, 56, 40, 350, DateTimeKind.Local).AddTicks(5137),
                            DateModified = new DateTime(2023, 9, 2, 16, 56, 40, 350, DateTimeKind.Local).AddTicks(5192),
                            DefaultDays = 5,
                            Name = "Illness"
                        });
                });
